...
| `planning` | lightweight task with `prd.md` complete | run `task.py start` for an explicit implementation request when no user-owned decision remains |
| `planning` | complex task missing `design.md` or `implement.md` | complete missing planning artifacts |
| `planning` | complex task has `prd.md`, `design.md`, and `implement.md` | run `task.py start` for an explicit implementation request when no user-owned decision remains |
