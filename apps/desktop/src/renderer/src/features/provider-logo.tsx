...
function ClaudeLogo({ className }: LogoProps) {
  return (
    <svg viewBox="0 0 16 16" fill="#D97757" className={className} aria-hidden>
...
function CodexLogo({ className }: LogoProps) {
  return (
...
// Gemini — official four-point spark from Simple Icons (googlegemini)
function GeminiLogo({ className }: LogoProps) {
  return (
    <svg viewBox="0 0 24 24" fill="#8E75B2" className={className} aria-hidden>
...
function CopilotLogo({ className }: LogoProps) {
  return (
...
function CursorLogo({ className }: LogoProps) {
  return (
    <svg viewBox="600 300 400 400" fill="none" className={className} aria-hidden>
      <path
        fill="#14120B"
...
export function ProviderLogo({
  ...
  switch (providerKey(provider)) {
    case "claude":
      return <ClaudeLogo className={cls} />;
    case "codex":
      return <CodexLogo className={cls} />;
    case "gemini":
      return <GeminiLogo className={cls} />;
    case "opencode":
      return <OpenCodeLogo className={cls} />;
    case "copilot":
